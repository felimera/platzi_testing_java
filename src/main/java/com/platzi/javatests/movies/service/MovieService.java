...
public class MovieService {
    ...
    public Collection<Movie> findMoviesByName(String nameMovie) {
        return movieRepository.findAll().stream().filter(movie -> movie.getName().toLowerCase().contains(nameMovie.toLowerCase())).collect(Collectors.toList());
    }
}
