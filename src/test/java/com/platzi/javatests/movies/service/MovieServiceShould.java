...
public class MovieServiceShould {
    ...
    public void return_movies_by_genre() {
        List<Integer> movieIds = getMoviesIds(movieService.findMoviesByGenre(Genre.COMEDY));
        assertThat(movieIds, is(Arrays.asList(3, 6)));
    }

    @Test
    public void return_movies_by_length() {
        List<Integer> movieIds = getMoviesIds(movieService.findMoviesByLength(119));
    ...
    private List<Integer> getMoviesIds(Collection<Movie> movieService) {
